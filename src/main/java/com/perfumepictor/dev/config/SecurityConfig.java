...
import com.perfumepictor.dev.config.jwt.JwtTokenProvider;
    ...
    protected SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests((authorizeRequests) ->
                        authorizeRequests
                                .requestMatchers("/", "/api/v1/temp/**", "/api/v1/auth/**", "/api/v1/s3/presigned-url")
                                .permitAll()
...
//                )
                ...
                .jwt()
                .jwkSetUri("https://cognito-idp.ap-northeast-2.amazonaws.com/ap-northeast-2_2J9Z2Q5ZS/.well-known/jwks.json");
